...
export const envSchema = z.object({
  ...
  EVENTS_DB_PORT: z.coerce.number().default(5432),
  EVENTS_DB_USER: z.string(),
  EVENTS_DB_HOST: z.string().default('localhost'),
  EVENTS_DB_PASSWORD: z.string().min(5),
  EVENTS_DB_NAME: z.string(),
